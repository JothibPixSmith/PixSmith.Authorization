        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AbsoluteRefreshTokenLifetimeSeconds = table.Column<int>(type: "integer", nullable: true),
                    ...
                    CorsOriginsJson = table.Column<string>(type: "text", nullable: false),
                    CreatedByUserId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OAuthClientRegistrations", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OAuthClientRegistrations_ClientId",
